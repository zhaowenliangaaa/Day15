...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">关键字查询 </span>
			      <input type="text" name="txt_search_key" class="form-control" id="txt_search_key" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">学生姓名 </span>
			      <input type="text" name="txt_search_name" class="form-control" id="txt_search_name" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<input type="date" name="txt_search_entrytime1" class="form-control" id="txt_search_entrytime1" >—
					<input type="date" name="txt_search_entrytime2" class="form-control" id="txt_search_entrytime2" >
				</div>
			 </div>
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_c_edit" role="dialog" aria-labelledby="modal_c_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_c" method="post" action="reserveC.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>课程名：</td>
								<td><input type="text" id="name" name="name"
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_c_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    $("#submit_form_c_btn").click(function(){
	    	$("#form_c").submit();
	    });
	});
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addC").click(function(){
	    		...
	    		$("#form_c").resetForm();
	    		$('#modal_c_edit').modal({backdrop: 'static', keyboard: false});
				$('#modal_c_edit').modal('show');
	        });
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	if(res.success){
	    		    		...
	    		    		debugger;
	    		    		//初始化一个echarts实例
	    		    		var myehcarts = echarts.init(document.getElementById("main"));
	    		    		...
	    		    		*/
	    		    		...
	    		    		//option配置项赋值给ehcarts实例
	    		    		
	    		    		myehcarts.setOption(option);
